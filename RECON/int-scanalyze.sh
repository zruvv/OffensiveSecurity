...
cat $tcp_file | awk '/80\/open/ {print $2}' > $path/hosts_ports/hosts_80.txt
cat $tcp_file | awk '/443\/open/ {print $2}' > $path/hosts_ports/hosts_443.txt
cat $tcp_file | awk '/8080\/open/ {print $2}' > $path/hosts_ports/hosts_8080.txt
cat $tcp_file | awk '/22\/open/ {print $2}' > $path/hosts_ports/hosts_22.txt
cat $tcp_file | awk '/445\/open/ {print $2}' > $path/hosts_ports/hosts_445.txt
cat $tcp_file | awk '/21\/open/ {print $2}' > $path/hosts_ports/hosts_21.txt
cat $tcp_file | awk '/23\/open/ {print $2}' > $path/hosts_ports/hosts_23.txt
cat $tcp_file | awk '/25\/open/ {print $2}' > $path/hosts_ports/hosts_25.txt
cat $tcp_file | awk '/69\/open/ {print $2}' > $path/hosts_ports/hosts_69.txt
cat $tcp_file | awk '/1433\/open/ {print $2}' > $path/hosts_ports/hosts_1433.txt
cat $tcp_file | awk '/3389\/open/ {print $2}' > $path/hosts_ports/hosts_3389.txt
cat $tcp_file | awk '/3306\/open/ {print $2}' > $path/hosts_ports/hosts_3306.txt
